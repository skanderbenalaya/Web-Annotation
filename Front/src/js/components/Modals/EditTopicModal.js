...
import { ModifyTopic } from "../../store/actions/topicActions";
...
export default function EditButton() {
  ...
  return (
    <React.Fragment>
      <EditIcon
        disabled={
          count === 0 || selectedTopic === "" || selectedTopic === "Général"
        }
        onClick={toggleModal}
      />
      <ModalBox
          ...
          <Button
            ...
            onClick={() => {
              if (text === "") {
                ...
                dispatch(ModifyTopic(selectedTopic, text));
                toggleModal();
              }
            }}
          >
